...
class TestBase:
    ...
    def test_collapse_elements_container(self, page: Page):
        ...
        element_list_class: str = element_group.eval_on_selector('.element-list', 'el => el.className')
...
class TestTextBox:
    ...
    def test_submit_valid_data(self, page: Page):
        ...
        current_address_field: ElementHandle = user_form.wait_for_selector('#currentAddress')
        permanent_address_field: ElementHandle = user_form.wait_for_selector('#permanentAddress')
        ...
        for key, value in self.user.items():
            ele_value: str = output_field.eval_on_selector(f'#{key}', 'el => el.innerText')
    ...
    def test_error_when_invalid_email(self, page: Page):
        ...
        email_class: str = user_form.eval_on_selector('#userEmail', 'el => el.className')
